                                        ...
                                        <div class="card-body">
                                          <div class="form-group row">
                                            ...
                                            <select class="form-control" required name="status_re">
                                                ...
                                                <option value="0" <?php echo $row['status_re'] == '0'? 'selected': '' ?>>รออนุมัติ</option>
                                                <option value="1" <?php echo $row['status_re'] == '1'? 'selected': '' ?>>ไม่อนุมัติ</option>
                                                <option value="2" <?php echo $row['status_re'] == '2'? 'selected': '' ?>>อนุมัติ</option>
                                            </select>
                                            </div>
